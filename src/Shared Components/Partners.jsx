...
const Partners = () => {
  const partnerList = [
    { name: "Sky Drift", type: "Air", icon: <Plane size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Urban Wave", type: "Bus", icon: <Bus size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Ocean Glide", type: "Ship", icon: <Ship size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Cloud Hopper", type: "Air", icon: <Plane size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Route Master", type: "Bus", icon: <Bus size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Deep Sea Lux", type: "Ship", icon: <Ship size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Aero Swift", type: "Air", icon: <Plane size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
    { name: "Nomad Express", type: "Bus", icon: <Bus size={20} />, color: "bg-white text-gray-700", iconBg: "bg-orange-500" },
  ];
