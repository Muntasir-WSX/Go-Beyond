  ...
  const slides = [
    {
      ...
      desc: "Experience the majestic hills and clouds of the Chittagong Hill Tracts.",
    },
    {
      img: coxBazar,
      title: "Relax at Cox's Bazar",
      desc: "Unwind on the world's longest natural sandy sea beach.",
    },
    {
      img: sajek,
      title: "Escape to Sajek Valley",
      desc: "The cottage in the clouds is calling for your next getaway.",
    },
    {
      img: saintMartin,
      title: "Crystal Waters of Saint Martin",
      desc: "Explore the only coral island in Bangladesh.",
    },
    {
      img: kaptai,
      title: "Serenity of Kaptai Lake",
      desc: "Boat rides and peaceful sunsets in the heart of Rangamati.",
    },
    {
      img: naval2,
      title: "Evening Vibes at Naval Port",
      desc: "Enjoy the refreshing breeze and harbor views of Chittagong.",
    },
    {
      img: rangamati,
      title: "Culture & Nature of Rangamati",
      desc: "Discover the tribal heritage and hanging bridges.",
    },
  ];
    ...
    <main className="relative min-h-screen font-sans bg-white overflow-x-hidden">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md px-6 py-1 rounded-full border border-white/20 shadow-lg">
                        <span className="text-white text-xl font-light tracking-[0.3em] uppercase">
                          Go{" "}
                          <span className="text-[#ff5e37] font-bold">
                            Beyond
                          </span>
                        </span>
                      </div>
        ...
        <div className="hidden lg:block absolute -bottom-16 left-1/2 -translate-x-1/2 z-40 w-[95%] max-w-6xl px-4">
          ...
          >
            <div className="flex-1 px-6 py-3 border-r border-gray-100 group cursor-pointer hover:bg-orange-50/30 transition-colors">
              <span className="text-[11px] text-[#ff5e37] font-black uppercase tracking-widest text-left block">
                Destination
              </span>
              <p className="text-gray-800 font-bold text-lg text-left">
                Where to?
              </p>
            </div>
            <div className="flex-1 px-6 py-3 border-r border-gray-100 group cursor-pointer hover:bg-orange-50/30 transition-colors">
      ...
      <section ref={featuredSectionRef} className="py-10 bg-white">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <React.Suspense
            fallback={<div className="...">Loading Packages...</div>}
          >
