      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex items-center gap-5 group">
          <div className="bg-white p-5 rounded-full shadow-sm group-hover:bg-[#ff5e37] transition-all duration-300">
            <BadgeDollarSign
              size={40}
              className="text-[#ff5e37] group-hover:text-white"
            />
          </div>
          <div>
            ...
            <p className="text-gray-500 text-sm max-w-50 leading-relaxed">
              Enjoy premium travel experiences at the most competitive rates in
              the market.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-5 group border-y md:border-y-0 md:border-x border-gray-200 py-8 md:py-0 md:px-12">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm max-w-50 leading-relaxed">
              Secure your dream destination in just a few clicks with our
        ...
        <div className="flex items-center gap-5 group">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm max-w-50 leading-relaxed">
              Explore a handpicked collection of unique journeys tailored to
