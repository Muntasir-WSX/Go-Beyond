        ...
        <div className="w-full max-w-md mx-auto py-8 lg:py-0">
          <div className="mb-5">
            <Link
              ...
              className="inline-flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest hover:text-[#ff5e37] mb-3 transition-colors"
            >
              <ArrowLeft size={12} /> Back to Login
            </Link>
            <h3 className="text-3xl font-black text-[#1a1b2e] uppercase tracking-tighter mb-2">
              Register
            </h3>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border-2 border-gray-100 rounded-xl py-2.5 pl-11 pr-4 focus:border-[#ff5e37] outline-none font-semibold text-[#1a1b2e] transition-all text-sm"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#1a1b2e] hover:bg-[#ff5e37] text-white font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 uppercase text-xs tracking-widest shadow-lg mt-2 active:scale-95"
            >
          ...
          <div className="relative my-5 text-center">
            ...
            <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-[9px] font-bold text-gray-400 uppercase tracking-widest">
              Or Register With
            </span>
          </div>
          ...
          <button
            ...
            className="w-full bg-white border-2 border-gray-100 hover:border-[#ff5e37] text-[#1a1b2e] font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-3 text-sm active:scale-95"
          >
            <FcGoogle size={20} />
          ...
          <p className="mt-5 text-center text-xs font-medium text-gray-500">
            ...
            <Link
              to="/signin"
              state={{ from: location.state?.from }}
              className="text-[#ff5e37] font-bold hover:underline"
            >
              Sign In Here
            </Link>
          </p>
        ...
        <div className="relative z-10 w-full h-full p-12 flex flex-col justify-between items-end text-right">
          <Link to="/" className="flex items-center group w-fit">
            <h1 className="text-2xl font-black tracking-tighter text-white">
              Go<span className="text-gray-300">Beyond</span>
            </h1>
          ...
          <div className="space-y-4">
            <h2 className="text-5xl font-black text-white leading-tight uppercase tracking-tighter">
              Explore <br />{" "}
              <span className="text-[#ff5e37]">New Horizons</span>
            </h2>
            <p className="text-lg text-gray-200 font-medium max-w-sm ml-auto">
              Unlock exclusive travel deals with your new account.
            </p>
          </div>
          <div className="text-gray-400 text-[10px] font-black uppercase tracking-widest">
            © 2026 GoBeyond Travel
          </div>
        </div>
      </div>
    </div>
