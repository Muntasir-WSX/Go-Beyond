            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500 text-base max-w-2xl mx-auto mt-4">
                        Our passionate team of travel enthusiasts and local experts are here to ensure your journey is smooth, memorable, and truly beyond expectations.
                    </p>
                </div>

                {/* Team Members Grid - 3 Members Layout */}
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#ff5e37]/90 to-transparent flex items-end justify-center pb-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="flex gap-4">
                                        ...
                                        {member.social.instagram && (
                                            <a href={member.social.instagram} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#1a1b2e] transition-colors bg-white/20 p-2 rounded-full backdrop-blur-sm">
                                                <Instagram size={18} />
                                            </a>
                                        )}
                                        {member.social.linkedin && (
                                            <a href={member.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#1a1b2e] transition-colors bg-white/20 p-2 rounded-full backdrop-blur-sm">
                                                <Linkedin size={18} />
                                            </a>
                                        )}
                                    </div>
